...
const TechItem = ({ icon, name, delay = 0 }: TechItemProps) => {
  return (
    <motion.div
      ...
      className="flex items-center gap-3 bg-neutral-800/50 dark:bg-neutral-800/50 backdrop-blur-sm rounded-lg p-3 hover:bg-neutral-700/50 transition-colors"
    >
    ...
    <section className="py-20 bg-neutral-100 dark:bg-black">
      <div className="container mx-auto px-4">
        ...
        <TechCategory title="FRONTEND" delay={0.1}>
          ...
          <TechItem icon={<SiNextdotjs className="text-white" />} name="Next.JS" delay={0.5} />
        ...
        <TechCategory title="BACKEND" delay={1.2}>
          ...
          <TechItem icon={<SiExpress className="text-white" />} name="Express.JS" delay={1.5} />
        </TechCategory>
        ...
        <TechCategory title="DATABASE" delay={1.6}>
          ...
          <TechItem icon={<SiPrisma className="text-white" />} name="Prisma" delay={2.0} />
        </TechCategory>

        <TechCategory title="TOOLS" delay={2.1}>
          <TechItem icon={<SiGit className="text-[#F05032]" />} name="Git" delay={2.2} />
          <TechItem icon={<SiGithub className="text-white" />} name="GitHub" delay={2.3} />
