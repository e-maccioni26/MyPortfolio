...
export default function CountUp({
  ...
  // Respecte « animations réduites » du système : on affiche directement la valeur finale.
  useEffect(() => {
  ...
  // La valeur de départ est rendue côté serveur pour éviter que le suffixe
  // (« + », « ans ») n'apparaisse seul avant l'hydratation.
  return (
